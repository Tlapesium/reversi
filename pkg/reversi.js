...
* @returns {Int32Array}
*/
export function alphabeta_js(player, board, depth) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.alphabeta_js(retptr, addHeapObject(player), addHeapObject(board), addHeapObject(depth));
...
* @returns {Int32Array}
*/
export function mcts_js(player, board, itr) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.mcts_js(retptr, addHeapObject(player), addHeapObject(board), addHeapObject(itr));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v0 = getArrayI32FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 4);
